...
- Usage limits apply
- Charges apply after credits expire

2. Amazon Web Services (AWS)
Free Tier Includes:
- 750 hours/month of EC2 (t2.micro)
- 5 GB S3 storage
- Free RDS, Lambda, and CloudWatch usage

Duration:
- 12 months (some services always free)

Limitations:
- Credit card required
- Easy to incur charges if limits exceeded
- Region-based restrictions

3. Google Cloud Platform (GCP)
Free Tier Includes:
- $300 free credits
- Free Compute Engine (small VM)
- Free Cloud Storage and BigQuery quotas
...
- Credit card required
- Resource usage caps
- Services restricted to specific regions
